import { Container, Box, VStack, HStack, Text, Heading, Button, Image, IconButton, SimpleGrid, Link } from "@chakra-ui/react";
import { FaRobot, FaBlog, FaFacebook, FaTwitter, FaInstagram } from "react-icons/fa";
  ...
  return (
    <Container maxW="container.xl" p={4}>
      ...
      <VStack spacing={8} alignItems="flex-start">
        {/* Hero Section */}
        <HStack spacing={8} alignItems="center" flexDirection={{ base: "column", md: "row" }}>
        ...
        <Box w="100%">
          ...
          <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={8}>
            <Box borderWidth="1px" borderRadius="md" overflow="hidden" _hover={{ transform: "scale(1.05)", transition: "0.3s" }}>
      ...
      <Box as="footer" bg="orange.500" color="white" py={4} mt={8}>
        <VStack spacing={4}>
          <HStack spacing={4}>
            <IconButton as={Link} href="https://facebook.com" aria-label="Facebook" icon={<FaFacebook />} colorScheme="whiteAlpha" variant="outline" />
            <IconButton as={Link} href="https://twitter.com" aria-label="Twitter" icon={<FaTwitter />} colorScheme="whiteAlpha" variant="outline" />
            <IconButton as={Link} href="https://instagram.com" aria-label="Instagram" icon={<FaInstagram />} colorScheme="whiteAlpha" variant="outline" />
          </HStack>
